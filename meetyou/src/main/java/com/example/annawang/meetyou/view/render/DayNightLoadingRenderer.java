...
public class DayNightLoadingRenderer extends LoadingRenderer {
    ...
    private static final int MAX_SUN_RAY_COUNT = 16;
    ...
    private static final int DEFAULT_COLOR = Color.parseColor("#fffcd03c");

    private static final long ANIMATION_DURATION = 8888;
    private static final int ANIMATION_REPEAT_COUNT = ValueAnimator.INFINITE;
    ...
    protected void draw(Canvas canvas, Rect bounds) {
        ...
        if (mMoonCoordinateY < mInitSun$MoonCoordinateY) {
            ...
            canvas.rotate(mMoonRotation, arcBounds.centerX(), 100);
            canvas.drawPath(createMoonPath(arcBounds.centerX(), 100), mPaint);
